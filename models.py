...
class CNN_Model():
    ...
    def build(self):
        # add model layers
        self.model.add(Conv2D(32, kernel_size=3, activation=self.activation, input_shape=(self.time_steps, self.data_dim, 1),
                              padding = "same",
...
class CNN_1d_Model():
    ...
    def build(self):
        # add model layers
        self.model.add(Conv1D(32, kernel_size=20, activation=self.activation, input_shape=(self.time_steps, self.data_dim),
                              padding = "same",
                              kernel_regularizer=regularizers.l2(0.002)))
        # self.model.add(Dropout(0.1))
        self.model.add(Conv1D(32, kernel_size=20, activation=self.activation, 
                              padding = "same",
